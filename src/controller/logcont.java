...
public class logcont implements Initializable {
    ...
    void logaction(ActionEvent event) {
        ...
        pt.setOnFinished(ev -> {
            ...
            Parent root;
            if(MySQLAccess.searchStudent(email, pass)){
    ...
    void pageup(ActionEvent event) throws IOException {
        log.getScene().getWindow().hide();
        Parent root = FXMLLoader.load(getClass().getResource("/layout/sign.fxml"));
        Stage s = new Stage();
        Scene scene = new Scene(root);
        s.setScene(scene);
        s.setTitle("exam");
    ...
    void pass(ActionEvent event) {
        ...
        Parent root;
            try {
                root = FXMLLoader.load(getClass().getResource("/layout/forgotpass.fxml"));
                Stage s = new Stage();
                Scene scene = new Scene(root);
                s.setScene(scene);
                s.setTitle("exam");
