 ...
 */
public class teachsigncont implements Initializable {

    @FXML
    private AnchorPane teachsign;
    ...
    void pagein(ActionEvent event) throws IOException {
        teachsign.getScene().getWindow().hide();
        Parent root = FXMLLoader.load(getClass().getResource("/layout/teachlog.fxml"));
        Stage s = new Stage();
    ...
    void signup(ActionEvent event) {
        ...
        pt.setOnFinished(ev -> {
            ...
            if(MySQLAccess.existTeacher(email)){
            ...
            MySQLAccess.insertTeacher(username, email, pass);
